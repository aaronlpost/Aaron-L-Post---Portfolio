...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/_themes/london-wild/css/london-wild.css" />
  </head>
  <body>
    <div class="container" style="margin-top:100px;">
      <div class="row">
        <div class="span8 offset2">
          ...
          <h2>Installation requirements tested for Statamic.</h2>

          <?php if ($is_ready): ?>
            <h3 class="ready">Good job, son. Your server is worthy.</h3>
            <p>It would appear your server is ready run Statamic.</p>
          <?php else: ?>
            <?php if ($have_rewrite): ?>
